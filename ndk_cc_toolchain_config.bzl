    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        **ndk_cc_toolchain_config(
            ...
            tools = {
                ...
                "gcc": ctx.attr.ndk_path + "/" + ctx.attr.clang_directory + "/bin/clang" + ctx.attr.executable_extension,
                ...
                "nm": ctx.attr.ndk_path + "/" + ctx.attr.clang_directory + "/bin/llvm-nm" + ctx.attr.executable_extension,
